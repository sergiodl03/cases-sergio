  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 space-y-20">
        {/* El space-y-20 sustituye a tus div h-30 para separar bloques */}

        {/* BLOQUE 1: AHORA "FLOTANTE" */}
        <div className="flex flex-col md:flex-row relative overflow-hidden ">
          {/* Imagen con bordes redondeados para que se vea que no toca el borde */}
          <div
          ...
          {/* Contenido que invade */}
          <div className="w-full md:w-[40%] md:h-150 flex items-center justify-start md:-ml-20 z-10 p-4 md:p-0">
            <div className="flex flex-col items-center justify-center text-center h-fit min-h-[300px] bg-black/40 p-8 max-w-md shadow-2xl backdrop-blur-md rounded-xl border border-white/10">
      ...
      {/* BLOQUE 2: PERROS */}
        <div className="flex flex-col md:flex-row relative overflow-hidden">
          ...
          <div className="w-full md:w-[40%] h-150 flex items-center justify-end -mr-20 z-10">
            <div className="flex flex-col items-center justify-center text-center h-fit min-h-[300px] bg-black/40 p-8 max-w-md rounded-xl border border-white/10 shadow-2xl backdrop-blur-md">
      ...
      {/* BLOQUE 3: TERRAZA */}
        <div className="flex flex-col md:flex-row relative overflow-hidden">
          ...
          <div className="w-full md:w-[40%] h-150 flex items-center justify-start -ml-20 z-10">
            <div className="flex flex-col items-center justify-center text-center h-fit min-h-[300px] bg-black/40 p-8 max-w-md rounded-xl border border-white/10 shadow-2xl backdrop-blur-md">
              <h4 className="text-indigo-500 text-2xl font-black uppercase italic mb-4">
