...
const Card = ({ imagen, nombre, descripcion, precio, alergeno }) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between">
          ...
          <span
            key={alergeno}
            className="text-[10px] font-bold tracking-[0.2em] uppercase text-indigo-400 bg-indigo-500/10 w-fit px-2 py-1 rounded"
          >
            {alergeno}
          </span>
        </div>
